      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-5 col-md-2 mx-3 mb-4">
            ...
            <ul className="list-unstyled" id="line-space1">
              <li>
                <Link href="/bulk-sms" className="text-white text-decoration-none hover ">
                  <FontAwesomeIcon icon={faAngleDoubleRight} className="me-2" />
                  Bulk SMS
                </Link>
              </li>
              <li>
                <Link href="/whatsapp-api" className="text-white text-decoration-none hover  pt-2">
                  <FontAwesomeIcon icon={faAngleDoubleRight} className="me-2" />
                  WhatsApp
                </Link>
              </li>
              <li>
                <Link href="/rcs-service" className="text-white text-decoration-none hover  pt-2">
                  <FontAwesomeIcon icon={faAngleDoubleRight} className="me-2" />
                  RCS SMS
                </Link>
              </li>
              <li>
                <Link href="/voice-call" className="text-white text-decoration-none hover  pt-2">
                  <FontAwesomeIcon icon={faAngleDoubleRight} className="me-2" />
                  Bulk Voice Call
                </Link>
              </li>
